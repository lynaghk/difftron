...
mod tests {
    ...
    #[test]
    fn syntax_aware_clojure_diff_reports_structure_for_valid_forms() {
        let lhs = "(defn meaning [] 41)\n";
    ...
    #[test]
    fn malformed_clojure_snippets_surface_explicit_fallback() {
        let lhs = "(defn meaning [] 41\n";
        let rhs = "(defn meaning [] 42)\n";
