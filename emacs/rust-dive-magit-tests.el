    ...
    (list
     (list
      ...
      (rust-dive-magit-tests--side
       (plist-get lhs :source_text) lhs-novel)
      :right
      (rust-dive-magit-tests--side
       (plist-get rhs :source_text) rhs-novel))))))
...
(cl-defun
 ...
 (list
  :command "diff"
  :lhs
  (rust-dive-magit-tests--git-revision lhs-label lhs-rev)
  :rhs
  (rust-dive-magit-tests--git-revision rhs-label rhs-rev)
  :added added
  :deleted deleted
  :modified modified))
